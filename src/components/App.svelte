<script>
  ...
  $: if ((keyframes !== null) && (prev !== null) && (next !== null) && (color !== null)) {
    ...
    let lg_height = (document.body.clientHeight / count) / 3 * 2;
